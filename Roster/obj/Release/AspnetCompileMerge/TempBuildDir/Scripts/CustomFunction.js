...
function InitializeAdvanceMCEEditor() {
    tinyMCE.init({
        ...
        plugins: "lists,pagebreak,style,layer,advhr,iespell,insertdatetime,noneditable,visualchars,nonbreaking,xhtmlxtras,template,inlinepopups,autosave",

        // Theme options
        theme_advanced_buttons1: "bold,italic,underline,strikethrough,|,justifyleft,justifycenter,justifyright,justifyfull,styleselect,formatselect,fontselect,fontsizeselect,|,bullist,numlist,|,forecolor,backcolor",
...
function readImageURL(controlID, imageID) {
    ...
    //  alert('Invalid image format');
    if (ValidImage == 2)
        swal('', 'Maximum size of uploaded content is 4 MB', 'error');
